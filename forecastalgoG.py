...
def runAnalyses(listofNumb):
    ...
    print("\nPlease contact juand.gutierrezc@pucp.edu.pe for questions and inquiries about the programs logic!\n")
...
def main():
    ...
    commands()
    while(cont):
        pricelist = [float(i) for i in getList(r'C:\Users\Juan Diego\Documents\Forex_Training_models_repositori\ForexAssistant-master\test.csv')]
